...
const { imports, minify, preset, processes, cleanOutputs, cleanProcesses, serve, observe } = require('./tasks');
...
exports.production = series(cleanOutputs, imports, processes, preset, minify, cleanProcesses);
